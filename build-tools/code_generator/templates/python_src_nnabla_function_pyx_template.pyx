...
# - build-tools/code_generator/templates/python_src_nnabla_function_pyx_template.pyx
# - build-tools/code_generator/generator/generate_python_src_nnabla_function_pyx.py
...
cdef class Function:
    ...
    def _cg_call(self, inputs, int n_outputs, outputs, cpp_bool execute):
        ...
        assert allisinstance(inputs, Variable)
...
# ---------------
#
# Python function uses Callback function implemneted in C++.
...
cdef class UnsafeVariable:
    """This is a Python wapper class for Variable class in C++.
...
cdef void cleanup_callback(void *cself) with gil:
    """Decrese a reference count of PythonFunction.
    """
...
cdef class PythonFunction(Function):
    ...
    @property
    def name(self):
        raise NotImplementedError("Impelment `name`.")

    def min_outputs(self):
        raise NotImplementedError("Impelment `min_outputs`.")

    def setup_impl(self, inputs, outputs):
        raise NotImplementedError("Impelment `setup`.")

    def forward_impl(self, inputs, outputs):
        raise NotImplementedError("Impelment `forward`.")

    def backward_impl(self, inputs, outputs, propagate_down, accum):
        raise NotImplementedError("Impelment `backward`.")
# ==============================================================================
# Python Function End
# ==============================================================================
