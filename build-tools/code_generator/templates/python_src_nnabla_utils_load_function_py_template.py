...
.. note::
    ...
    - :file:`build-tools/code_generator/generator/generate_python_src_nnabla_utils_load_function_py.py`
    - :file:`build-tools/code_generator/templates/python_src_nnabla_utils_load_function_py_template.py`
'''
