...
template<typename T>
DataParallelCommunicator<T>::DataParallelCommunicator(const Context &ctx) : Communicator(ctx) {}

template<typename T>
DataParallelCommunicator<T>::~DataParallelCommunicator() {}

template<typename T>
void DataParallelCommunicator<T>::init() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU init is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::reduce(bool division) {
  NBLA_ERROR(error_code::not_implemented,
...
template<typename T>
void DataParallelCommunicator<T>::bcast() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU bcast is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::allgather() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU allgather is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ireduce(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ireduce is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::iallreduce(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU iallreduce is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ireducescatter(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ireducescatter is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ibcast() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ibcast is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::iallgather() {
  NBLA_ERROR(error_code::not_implemented,
...
template<typename T>
void DataParallelCommunicator<T>::bcast_async() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU bcast_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::allgather_async() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU allgather_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ireduce_async(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ireduce_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::iallreduce_async(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU iallreduce_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ireducescatter_async(bool division) {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ireducescatter_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::ibcast_async() {
  NBLA_ERROR(error_code::not_implemented,
      "CPU ibcast_async is not implemented.")
}

template<typename T>
void DataParallelCommunicator<T>::iallgather_async() {
  NBLA_ERROR(error_code::not_implemented,
...
vector<string> DataParallelCommunicator<T>::allowed_array_classes() {
  NBLA_ERROR(error_code::not_implemented,
      "Derived class of DataParallelCommunicator must implement allowed_array_classes().")
}
