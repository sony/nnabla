...
NBLA_REGISTER_FUNCTION_SOURCE(INQAffine, int, int, const vector<int> &,
                              const string &, int);

template <typename T, typename T1>
void INQAffine<T, T1>::setup_impl(const Variables &inputs,
...
template class INQAffine<float, int>;
} // namespace nbla
