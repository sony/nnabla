...
*/
#define NBLA_REGISTER_COMMUNICATOR_IMPL(BASE, CLS, RANK, BACKEND, ENGINE, ...)       \
  {                                                                                  \
...
#define NBLA_REGISTER_COMMUNICATOR_SOURCE(NAME, ...)                                  \
  FunctionRegistry<Communicator, ##__VA_ARGS__> &get_##NAME##CommunicatorRegistry() { \
...
#define NBLA_REGISTER_COMMUNICATOR_IMPL(BASE, CLS, RANK, BACKEND, ENGINE, ...)       \
  {                                                                                  \
    std::function<shared_ptr<Communicator>(const Context &, ##__VA_ARGS__)> func =   \
        [](NBLA_ARGDEFS(const Context &, ##__VA_ARGS__)) {                           \
          return shared_ptr<Communicator>(                                           \
