...
def onnx_non_max_suppression_backward(inputs, max_output_boxes_per_class=None, iou_threshold=None, score_threshold=None):
    """
    Args:
    ...
    raise NotImplementedError(
        "onnx_non_max_suppression_backward is not implemented.")
