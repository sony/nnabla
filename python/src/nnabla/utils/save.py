...
def _create_optimizer(datasets, name, solver, network, dataset_names, weight_decay, lr_decay, lr_decay_interval, update_interval):
    ...
    if o.solver.type == 'Adadelta':
        ...
        o.solver.rmspropgraves_param.lr = solver.info['lr']
        o.solver.rmspropgraves_param.decay = solver.info['decay']
        o.solver.rmspropgraves_param.momentum = solver.info['momentum']
        o.solver.rmspropgraves_param.eps = solver.info['eps']
