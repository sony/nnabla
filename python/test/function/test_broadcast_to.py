...
RESET_PARAMS = [
    ...
    ((4, 3, 4), (3), (2, 3, 4), (3), 1),
    ((3, 3, 4), (4), (2, 3, 4), (4), 2),
    ((3, 3, 4), (3, 3), (2, 3, 4), (2, 3), 0),
    ((2, 4, 4), (4, 4), (2, 3, 4), (3, 4), 1),
    ((3, 3, 4, 5), (3), (2, 3, 4, 5), (2), 0),
    ((2, 4, 4, 5), (4), (2, 3, 4, 5), (3), 1),
    ((2, 3, 2, 5), (2), (2, 3, 4, 5), (4), 2),
    ((2, 3, 4, 4), (4), (2, 3, 4, 5), (5), 3),
    ((3, 3, 4, 5), (3, 3), (2, 3, 4, 5), (2, 3), 0),
    ((2, 2, 4, 5), (2, 4), (2, 3, 4, 5), (3, 4), 1),
    ((2, 3, 2, 5), (2, 5), (2, 3, 4, 5), (4, 5), 2),
    ((3, 3, 4, 5), (3, 3, 4), (2, 3, 4, 5), (2, 3, 4), 0),
    ((2, 2, 4, 5), (2, 4, 5), (2, 3, 4, 5), (3, 4, 5), 1),
    ((2, 3, 4, 3), (3), (2, 3, 4, 5), (5), -1),
    ((2, 3, 4, 4), (4, 4), (2, 3, 4, 5), (4, 5), -1),
    ((2, 3, 2, 5), (3, 2, 5), (2, 3, 4, 5), (3, 4, 5), -1),
    ((2, 3, 2, 5), (2, 3, 2, 5), (2, 3, 4, 5), (2, 3, 4, 5), -1),
    ((2, 3, 2, 5), (2, 3, 2, 5), (2, 3, 4, 5), (2, 3, 4, 5), -2)
]
...
@pytest.mark.parametrize("seed", [314])
@pytest.mark.parametrize("fname, ctx, func_name", list_ctx_and_func_name(['broadcast_to']))
@pytest.mark.parametrize("xs, ys,reset_xs,reset_ys,axis", RESET_PARAMS)
def test_broadcast_to_forward_with_reset(xs, ys, reset_xs, reset_ys, axis, seed, fname, ctx, func_name):
    rng = np.random.RandomState(seed)
    ref_func = eval('ref_' + fname)
    func = getattr(F, fname)
    inputs = [rng.random_sample(xs), rng.random_sample(ys)]
    reset_inputs = [rng.random_sample(reset_xs), rng.random_sample(reset_ys)]
    function_tester(rng, func, ref_func, inputs, [axis],
                    backward=[False, False],
